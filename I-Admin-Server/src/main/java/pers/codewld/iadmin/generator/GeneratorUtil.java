...
public class GeneratorUtil {
    ...
    static void loadConfigurations() throws IOException {
        configuration = new Yaml().load(Files.newInputStream(Paths.get(baseDir + "/src/main/resources/generator/config.yml")));
    }
        ...
        try {
            ...
            FastAutoGenerator.create(url, username, password)
                    ...
                    .templateConfig(builder ->
                            builder
                                    .controller("/generator/template/controller.java")
                                    .entity("/generator/template/entity.java")
                                    .mapper("/generator/template/mapper.java")
                                    .xml("/generator/template/mapper.xml")
                                    .service("/generator/template/service.java")
                                    .serviceImpl("/generator/template/serviceImpl.java"))
                    .execute();
        } catch (IOException e) {
